...
## Strengthening security across cloud and hybrid platforms. <br>Autonomous execution.  Principled design.  Practical DevSecOps engineering.
---
## 🧭 Navigation  
🔹[About](#about) 
...
| **Hybrid Identity and File Migration Projekt: <br>🛡️ Microsoft Zero Trust IAM <br>🔐 Hybrid Identity + Data Migration** |  Designed and implemented a secure hybrid identity architecture by synchronizing on-prem Active Directory with Microsoft Entra ID using Entra Connect, enforcing Conditional Access policies, and migrating NTFS file shares to SharePoint Online. Validated cloud-native authentication, access auditing, and Zero Trust controls through Entra sign-in logs, Purview activity, and controlled access simulations  | Windows Server, Active Directory, Microsoft Entra ID, Entra Connect, SharePoint Online, Conditional Access, Purview, Log Analytics, Hybrid IAM, Zero Trust  |
