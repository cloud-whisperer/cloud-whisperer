...
| **[**🐧 Linux Network Health Check**](https://github.com/your-repo-link-here)** <br> **<br>- Network Visibility Tool**<br> |  **🛠️ <u>Developed a Bash-based network diagnostics utility by:<br></u>**  <br>- **Performing ICMP-based internet connectivity checks.**<br>- **Validating DNS resolution using system name services.**<br>- **Enumberated active listening ports and scanned for commonly &nbsp;&nbsp;&nbsp;exposed or high-risk ports.**<br>- **Implemented modular functions, interactive menus, and enhanced terminal feedback** (spinners & ASCII banners). | 🔧 **Technologies & Concepts Applied**<br>- 🐚 **Bash (Shell Scripting)**<br>- 📡 **Linux Networking Tools:** `ping`, `ss`, `getent`<br>- ⚙️ **Process Management:** background jobs & PIDs<br>- 🎨 **Terminal UX:** ANSI colors, structured output, ASCII banners |
