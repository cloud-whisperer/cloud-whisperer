...
| **[**👉 Linux Network Health Check**](https://github.com/your-repo-link-here) <br> **<br>Bash Fundamentals - Network Visibility Tool**<br> | **🌐 Linux Network Health Check** |  **🌐 Linux Network Health Check**<br>🐚 **Beginner Bash Networking Projekt** | 🛠️ **Developed a Bash-based network diagnostics utility by:**<br>- **Performing ICMP-based internet connectivity checks.**<br>- **Validating DNS resolution using system name services.**<br>- **Enumerating active listening ports and identifying commonly exposed or high-risk ports.**<br>- **Implementing modular functions, interactive menus, and enhanced terminal feedback** (spinners & ASCII banners). | 🔧 **Technologies & Concepts Applied**<br>- 🐚 **Bash (Shell Scripting)**<br>- 📡 **Linux Networking Tools:** `ping`, `ss`, `getent`<br>- ⚙️ **Process Management:** background jobs & PIDs<br>- 🎨 **Terminal UX:** ANSI colors, structured output, ASCII banners |
