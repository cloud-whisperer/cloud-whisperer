...
| **🚀  AWS -  Event-Driven <br>Order Processing Workflow** | End-to-end serverless workflow to handle: <br>- Orders <br>- Alerts <br>- Message queuing  |  - 🧠 Lambda <br>- DynamoDB <br>- SNS <br>- SQS <br>- CloudWatch <br>- IAM |
