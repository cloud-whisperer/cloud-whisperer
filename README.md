...
| **🚀  AWS -  Event-Driven <br>Order Processing Workflow** | End-to-end serverless workflow to handle: <br>orders, alerts, and message queuing  | 🧠 - Lambda <br>- DynamoDB <br>- SNS <br>- SQS <br>- CloudWatch <br>- IAM |
