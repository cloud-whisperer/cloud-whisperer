...
| **🚀  AWS -  Event-Driven Order Processing** | End-to-end serverless workflow handling orders, alerts, and message queuing  | 🧠 Lambda, <br>- DynamoDB, <br>- SNS, <br>- SQS, <br>- CloudWatch, <br>- IAM |
