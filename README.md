...
| **[**👉 Linux Network Health Check — Bash Fundamentals** <br>**Network Visibility Tool**](https://github.com/your-repo-link-here)**<br> | **🌐 Linux Network Health Check** | 
| --- | --- | --- |
| 🛠️ **Developed a Bash-based network diagnostics utility that:**<br>
&nbsp;&nbsp;🌐 **Performs ICMP-based internet connectivity checks**<br>
&nbsp;&nbsp;🧭 **Validates DNS resolution using system name services**<br>
&nbsp;&nbsp;🔍 **Enumerates active listening ports and identifies commonly exposed or high-risk ports**<br>
...
&nbsp;&nbsp;📡 **Linux Networking Utilities:** `ping`, `ss`, `getent`<br>
&nbsp;&nbsp;⚙️ **Process Management:** background execution & PID handling<br>
&nbsp;&nbsp;🎨 **Terminal UX:** ANSI color codes, structured output, ASCII banners |
