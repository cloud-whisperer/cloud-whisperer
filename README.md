...
|--------|-------------|--------------|
| **🛡️ Manage Access Securely Using Azure Active Directory Groups and Roles** | 🛠️  Designed and validated role-based access control (RBAC) by creating a test user, and assigned group-based permissions. Verified least-privilege access through controlled login testing. | - **Microsoft Entra ID <br>(Azure AD)** <br>- **Users** <br>- **Groups** <br>- **Azure RBAC** <br>- **Built-in Reader Role** <br>- **Access Control (IAM)** |
