...
| **💜 Terraform projekt: <br>- AWS Edge Security <br>- Content Delivery** | Designed and provisioned a secure, production-grade CloudFront distribution with Lambda@Edge request inspection, AWS WAF IP blocking, and S3 origin protection, using Terraform modules and least-privilege IAM. Edge security controls. Deterministic module outputs. Auditable IaC workflows  | - Python<br> - CLI<br> - Logging<br> - Modular Design<br> - User Context<br> - Audit Trail|
